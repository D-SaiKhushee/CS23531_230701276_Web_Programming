...
const MedicalShop = () => {
    ...
    return (
        <div className='container my-4'>
            ...
            <input type='text' placeholder='Search Medicine' className='form-control mb-3'
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-4'>
                    <input type='number' placeholder='Price' step="0.01" className='form-control mb-2'
                    value={formData.price} onChange={handleChange} />
                </div>
            </div>
            <button className='btn btn-success w-100 mb-4' onClick={handleAddMedicine}>Add Medicine</button>
